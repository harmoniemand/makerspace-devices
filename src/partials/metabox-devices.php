...
<div class="row">
    <div class="col">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="kein Dokument ausgewählt" id="input_datenblatt"
                disabled
        ...
        <input type='hidden' name='datenblatt_attachment_id' id='datenblatt_attachment_id'
            value='<?php echo $datenblatt_attachment_id ?>'>
    ...
    <div class="col">
        ...
        <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="kein Dokument ausgewählt"
                id="input_bedienungsanleitung" disabled
                value="<?php if($bedienungsanleitung_attachment_id != NULL) { echo  get_the_title( $bedienungsanleitung_attachment_id ); } ?>">
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="button" id="button_bedienungsanleitung">Dokument
                    wählen</button>
            </div>
        </div>
        <input type='hidden' name='bedienungsanleitung_attachment_id' id='bedienungsanleitung_attachment_id'
            value='<?php echo $bedienungsanleitung_attachment_id ?>'>
