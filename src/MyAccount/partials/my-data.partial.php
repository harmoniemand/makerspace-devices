            ...
            <div class="card wp-settings" style="border-radius: 0; padding: 8px 12px;">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <label for="my_calendar_url" class="col-sm-2 col-form-label"><?php echo __('Vorname') ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <label for="my_calendar_url" class="col-sm-2 col-form-label"><?php echo __('Nachname') ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="my_calendar_url" id="my_calendar_url" class="form-control-plaintext" value="<?php echo $my_calendar_url ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="my_calendar_url" class="col-sm-2 col-form-label"><?php echo __('Straße') ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="my_calendar_url" id="my_calendar_url" class="form-control-plaintext" value="<?php echo $my_calendar_url ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="my_calendar_url" class="col-sm-2 col-form-label"><?php echo __('Hausnummer') ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="my_calendar_url" id="my_calendar_url" class="form-control-plaintext" value="<?php echo $my_calendar_url ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="my_calendar_url" class="col-sm-2 col-form-label"><?php echo __('PLZ') ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="my_calendar_url" id="my_calendar_url" class="form-control-plaintext" value="<?php echo $my_calendar_url ?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="my_calendar_url" class="col-sm-2 col-form-label"><?php echo __('Ort') ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="my_calendar_url" id="my_calendar_url" class="form-control-plaintext" value="<?php echo $my_calendar_url ?>" disabled>
                        </div>
                    </div>
