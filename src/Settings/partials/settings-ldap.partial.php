...
if (isset($_POST['makerspace_settings_ldap_nonce'])) {
...
<form method="POST" action="?page=ms_settings">
    ...
    <?php wp_nonce_field(basename(__FILE__), 'makerspace_settings_ldap_nonce'); ?>

    <div class="row mt-3" style="max-width: 100%;">
        <div class="col">
            <h1 class="wp-heading-inline" style="font-size: 23px;">LDAP Einstellungen</h1>
        </div>
    </div>
